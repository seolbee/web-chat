...
class LoginPopup {
    constructor(wsClient, alertBuilder) {
      this.init(wsClient, alertBuilder);
    }

    init(wsClient, alertBuilder){
      this._userId = "";
      this._password = "";
      ...
      this._alertBuilder = alertBuilder;
    ...
    async loginReqt(body){
      ...
      if(response.status == 200) {
        ...
        let alertObject = {title: "오류 입니다.", content: response.message, state: AlertType.ERROR}
        this._alertBuilder.createAlert(alertObject);
      }
    }
}
